...
export type TTokens = 'KAR' | 'KSM' | 'BNC' | 'DOT' | 'PHA' | 'RMRK' | 'PCX' | 'EDG' | 'ACA' | 'KINT' | 'QTZ'| 'MOVR' | 'USDT' | 'WBNB' | 'BTC' | 'CSM' | 'USDC';

export const ALLOW_TOKENS: (TTokens | string)[] = ['KAR', 'KSM', 'BNC', 'DOT', 'PHA', 'RMRK', 'PCX', 'EDG', 'ACA', 'KINT', 'QTZ', 'MOVR', 'USDT', 'WBNB', 'BTC', 'CSM', 'USDC'];
